                                                ...
                                                if (_dateUTC_) {
                                                    ...
                                                    if (_dateParse_) {
                                                        if (typeof Intl == "undefined") {
                                                            ...
                                                            _year_ = new Intl.DateTimeFormat(FCBase.rss.locale, {
                                                                year: "numeric"
                                                            }).format(_dateParse_);
                                                            _month_ = new Intl.DateTimeFormat(FCBase.rss.locale, {
                                                                month: "2-digit"
                                                            }).format(_dateParse_);
                                                            _monthLong_ = new Intl.DateTimeFormat(FCBase.rss.locale, {
                                                                month: "long"
                                                            }).format(_dateParse_);
                                                            _monthShort_ = new Intl.DateTimeFormat(FCBase.rss.locale, {
                                                                month: "short"
                                                            }).format(_dateParse_);
                                                            _weekdayLong_ = new Intl.DateTimeFormat(FCBase.rss.locale, {
                                                                weekday: "long"
                                                            }).format(_dateParse_);
                                                            _weekdayShort_ = new Intl.DateTimeFormat(FCBase.rss.locale, {
                                                                weekday: "short"
                                                            }).format(_dateParse_);
                                                            _day_ = new Intl.DateTimeFormat(FCBase.rss.locale, {
                                                                day: "2-digit"
                                                            }).format(_dateParse_);
                                                            _hour_ = new Intl.DateTimeFormat(FCBase.rss.locale, {
                                                                hour: "2-digit"
                                                            }).format(_dateParse_);
                                                            _minute_ = new Intl.DateTimeFormat(FCBase.rss.locale, {
                                                                minute: "2-digit"
                                                            }).format(_dateParse_);
                                                            _second_ = new Intl.DateTimeFormat(FCBase.rss.locale, {
                                                                second: "2-digit"
                                                            }).format(_dateParse_);
                                                        }
                                                    }
